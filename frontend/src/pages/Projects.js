...
function ProjectCard({ title, duration, description, tech }) {
...
function Projects() {
    const projectsData = [
        ...
        },
        {
            ...
            description: "Managed a client's proposal project with a team of 6 students to revamp the wellness room in Chestnut Residence. Conducted weekly meetings, set deadlines, and managed timelines with Gantt charts.",
        ...
        },
        {
            ...
            description: "Developed a diary web application that integrates with ChatGPT to provide AI-generated feedback on journal entries, enhancing user reflections and insights. Built with a full-stack approach using Python, JavaScript, and HTML/CSS, utilizing OpenAI's API for real-time comment generation.",
